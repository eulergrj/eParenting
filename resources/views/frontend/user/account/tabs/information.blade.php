...
<form method="post" action="{{route('frontend.user.profile.update')}}" enctype="multipart/form-data" class="form-horizontal">
    @csrf
    @method('PATCH')
        
    <div class="form-group row">        
        <label for="avatar_location" class="col-md-3 col-form-label text-md-right">@lang('Avatar')</label>
        
        <div class="col-md-9">            
            <input type="file" name="avatar_location" id="avatar_location" class="form-control-file">            
        </div>
    </div><!--form-group-->
